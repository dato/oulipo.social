...
class Account < ApplicationRecord
  ...
  validates :username, format: { without: Oulipo.invalid_glyphs_regex, message: "try it without that fifth symbol" }, if: -> { local?  && will_save_change_to_username? && actor_type != 'Application' }
